    ...
    return (
        <div className="main-content">
            <div>
                ...
                <h2>Minä</h2>
                <p>Olen Kim, 23-vuotias tietojenkäsittelyn opiskelija opiskelen Savonia ammattikorkekoulussa.</p>
                ...
                <p>Tämä sivu on tehty Reactilla ja ulkoasu on toteutettu CSS:llä. Sivun koodi on saatavilla     
                <a href="https://github.com/yourusername/yourrepository" target="_blank" rel="noopener noreferrer">GitHubissa</a>.
                </p>
