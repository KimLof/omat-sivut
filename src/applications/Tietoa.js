...
function Tietoa() {
    ...
    <div>
        ...
        <p>Tarkempaa tietoa minusta löydät <a href="https://www.linkedin.com/in/kimlof/" target="_blank" rel="noopener noreferrer">LinkedIn-profiilistani</a>.</p>
        <h2>Sivustosta</h2>
        <p>Tämä sivusto on luotu projektinäytteenä ja harjoitusalueena uusille taidoille, joita opin matkan varrella. Se on rakennettu käyttäen Reactia ja sivuston ulkoasu on suunniteltu CSS:llä.</p>
